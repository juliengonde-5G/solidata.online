...
![Dossier administratif complet](../rapports/cip-refonte-2026-09-12/maquettes/captures/Dossier_Complet.jpg)
...
![Dossier administratif d'un nouvel entrant](../rapports/cip-refonte-2026-09-12/maquettes/captures/Dossier_Vide.jpg)
*Maquette validée le 12/09/2026 — l'écran livré peut différer dans le détail.*

![En-tête de fiche et badges de situation](../rapports/cip-refonte-2026-09-12/maquettes/captures/Fiche_Situation.jpg)
*Maquette validée le 12/09/2026 — l'écran livré peut différer dans le détail.*
...
![Rubrique FSE+ du diagnostic](../rapports/cip-refonte-2026-09-12/maquettes/captures/Diagnostic_FSE.jpg)
*Maquette validée le 12/09/2026 — l'écran livré peut différer dans le détail.*
...
![Fenêtre de clôture d'un entretien](../rapports/cip-refonte-2026-09-12/maquettes/captures/Fiche_Suivi_Cloture.jpg)
*Maquette validée le 12/09/2026 — l'écran livré peut différer dans le détail.*
...
![Dossiers FSE+](../rapports/cip-refonte-2026-09-12/maquettes/captures/Dossiers_FSE.jpg)
*Maquette validée le 12/09/2026 — l'écran livré peut différer dans le détail.*
...
1. Dans le Dossier administratif, section **« Fiche pour le référent »**, tout en bas de l'onglet.
...
- **« Mon Récap »** — un récapitulatif d'une à deux pages, que la personne peut partager à un tiers de son choix : ses contrats, les grandes étapes datées (entretiens désignés par leur type — **entretien de conciliation et point avec le référent y apparaissent sous le libellé générique « Entretien d'accompagnement »**, pour ne pas laisser deviner un contentieux RSA ou un référent sur un document qui peut circuler —, PMSMP **sans le nom de l'entreprise ou de l'organisme d'accueil** *(une raison sociale peut, par elle-même, révéler ce que ce document exclut par ailleurs)*, actions désignées par leur catégorie), ses objectifs atteints ou en cours, sa sortie le cas échéant. **Aucun texte libre, aucune donnée de santé, de justice ni de situation sociale n'y figure — pas même une mention de leur absence.** *Ces deux neutralisations sont activées par défaut (réglage `insertion.recap_neutralise`, réversible par la direction) ; c'est grâce à elles que cette promesse tient. « Mon parcours en une page », qui ne circule pas, nomme lui son référent en toutes lettres et ne fait pas cette promesse-là.*
...
**Les rappels de rendez-vous** se paramètrent dans le **Dossier administratif**, section « Rappels de rendez-vous » : le **consentement** se recueille oralement — une phrase à lire à la personne lui explique qu'elle recevra un message la veille de chaque rendez-vous, qu'elle peut arrêter quand elle veut, et que **le message ne dit jamais pourquoi elle a rendez-vous** — puis se saisit à l'écran avec le **canal** (SMS ou e-mail) et le **destinataire** choisi parmi ses contacts, proposés **masqués**. **Dès l'enregistrement de l'accord, un message de vérification part aussitôt** sur ce contact, pour que la conseillère puisse demander à la personne, séance tenante, si elle l'a bien reçu. **Un permanent hors parcours ne peut pas consentir** (l'écran le refuse) ; **le retrait, lui, reste toujours possible**, y compris après la sortie. Le message de rappel, ensuite, part chaque jour à **18 h** (heure de Paris), pour les rendez-vous du lendemain des seules personnes ayant donné leur accord, et ne contient **que la date, l'heure du rendez-vous et le prénom de la conseillère — jamais le prénom de la personne** *(retiré depuis le 13/09/2026 : un chiffre de trop dans le numéro saisi suffisait à faire partir un prénom, accompagné du nom de la structure d'insertion, chez un inconnu)*. **Sans clé d'envoi configurée sur le serveur, rien ne part** — le système le dit, il ne prétend jamais avoir envoyé ce qu'il n'a pas envoyé.
...
> - La trace d'un rappel envoyé ne montre jamais le contact en clair — elle prouve qu'un message est parti, elle ne sert pas d'annuaire — et elle n'est conservée que **90 jours**.

---

## 13. La synthèse de dialogue de gestion

**Objectif** : transmettre à l'autorité de tutelle, une fois par an, le document qu'elle a elle-même
...
1. **Effectifs et ETP** — le chiffre **validé par l'ASP en premier** (base 1 820 h), le calcul de
   contrôle interne en second et nommé « effectif pondéré », jamais l'inverse.
2. **Publics à l'entrée** — par critère d'éligibilité, part de bénéficiaires du RSA (avec le chiffre
   ASP quand il existe), catégorie France Travail, référent unique déterminé ou non.
3. **Freins** — concernés à l'entrée, puis **levés / stables / aggravés** entre l'entrée et la dernière
   évaluation, actions engagées, orientations DORA et leur résultat. Le frein judiciaire n'y figure
   **sous aucune forme**.
4. **Accompagnement** — entretiens réalisés/échus par type, heures d'accompagnement (les mêmes lignes
   que vos feuilles de temps signées, § 10), aides mobilisées.
5. **Immersions** — conventions, jours, entreprises distinctes, **débouché** (dont embauches chez
   l'accueillant).
6. **Sorties** — le nouveau dénominateur : **toutes les fins de parcours de la période**, avec une
   ligne **« sortie non documentée »** explicite pour celles parties sans bilan classé ; les deux
   méthodes de calcul (l'ancienne et la nouvelle) imprimées côte à côte pour 2026, le temps que la
...
## 14. Ce qui protège les personnes
