...
> **Révision du 13/09/2026** — section 4.4 « Parcours Insertion » entièrement réécrite (elle décrivait encore 7 freins et trois jalons M1/M6/M12, et donnait **l'échelle des freins à l'envers**), numérotation du chapitre 4 corrigée (deux sections portaient le n° 4.4), puis **complétée le même jour** des écrans du cadre RSA et du temps d'accompagnement (nouveau menu « Temps d'accompagnement »). **Complétée le 14/09/2026** d'un paragraphe sur la synthèse de dialogue de gestion et le nouveau calcul des sorties (chantier D, v. 2.55.0, § 4.4). Le reste du guide n'a pas été revu à cette date.
>
...
- **Renouvellement de contrat** — lié au contrat, avec le volet rempli par l'encadrant technique **sur un lien qui s'ouvre sans compte** (depuis le 13/09/2026, valable 60 jours ; un compte SOLIDATA reste possible pour un encadrant qui en a un), puis triple validation ;
...
**La fiche s'organise en quatre onglets** (depuis le 13/09/2026) : **Situation** (freins — radar et écart entre l'entrée et le dernier bilan —, note de profil, frise, PMSMP, satisfaction, documents pour la personne), **Suivi** (entretiens & bilans, objectifs, actions CIP rattachées à un partenaire du référentiel, **journal de suivi** chiffré ADMIN/RH, grilles de compétences métier notées par l'encadrant), **Dossier administratif** (voir plus bas), **Diagnostic** (socle en sept rubriques + approfondissements repliés).
...
**Pilotage & indicateurs** (`/insertion/audit`) : taux de sorties par catégorie comparés aux **cibles conventionnelles** — affichées « objectif non paramétré » tant que la direction ne les a pas confirmées, jamais une valeur inventée —, ETP « contrôle » (la saisie ASP fait foi), typologies de publics non nominatives, délai moyen des diagnostics, cartographie des freins. Depuis le 14 septembre 2026, le **taux de sorties** se calcule sur **toutes les fins de parcours** de la période et non plus sur les seuls bilans de sortie rédigés : une personne partie sans entretien de sortie apparaît sur une ligne « sortie non documentée » (un indicateur de qualité, pas une faute) ; pour 2026 les deux méthodes sont affichées côte à côte. L'onglet **« Dialogue de gestion »** de la même page produit le document annuel transmis à l'autorité de tutelle avant la séance (« synthèse de dialogue de gestion », neuf blocs strictement non nominatifs, tout agrégat de moins de cinq personnes retiré) : « Aperçu » pour vérifier, « Générer et enregistrer (PDF) » pour l'instantané daté que l'on transmet, « CSV » pour la version tableur, historique des synthèses déjà transmises. Le bouton « Tableau des freins » produit l'export enrichi (45 colonnes) demandé par l'autorité.
...
**Cadre RSA (bénéficiaires du RSA)** : Solidarité Textiles est **structure d'accueil**, pas référent unique — elle n'écrit pas le contrat d'engagements réciproques, elle **alimente** le référent externe (CMS, France Travail). Dans le Dossier administratif, un badge d'en-tête et un tableau détaillé donnent l'**activité hebdomadaire** de la personne (temps de travail et accompagnement confondus, jamais présentés comme un « seuil ») ; un panneau « Fiche pour le référent » génère et trace la remise d'un document limitatif (9 rubriques, sans aucune donnée de santé ni judiciaire), imprime le **relevé d'assiduité**, et suit l'**actualisation mensuelle France Travail** pour les personnes concernées. Deux types d'entretien s'y ajoutent : « Point avec le référent » et « Entretien de conciliation (protection des droits) ». L'écran « Mes échéances » affiche un bloc **« Rendez-vous réguliers et rappels »** qui signale les référents non déterminés et les semaines basses.

**Documents pour la personne accompagnée** (depuis le 13/09/2026, onglet Situation, ADMIN/RH) : **« Mon parcours en une page »** (engagements, heures de la semaine sans aucun seuil, prochain rendez-vous, référent, documents remis — une page A4 en français simple) et **« Mon Récap »** (récapitulatif partageable du parcours, sans aucune donnée de santé, de justice ni de situation sociale). Un panneau du Dossier administratif recueille le **consentement à des rappels de rendez-vous** par SMS ou e-mail, envoyés la veille à 18 h sans jamais nommer le type d'entretien — révocable à tout moment, et sans effet tant qu'aucun accord n'a été donné.
