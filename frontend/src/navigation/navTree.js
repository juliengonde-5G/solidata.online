    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          // Refonte CIP PR B (2.53.0) — feuille de temps mensuelle par intervenant et par projet cofinancé.
          { label: "Temps d'accompagnement", path: '/insertion/temps', icon: Clock, roles: ['ADMIN', 'RH'] },
