          ...
          <>
            ...
            {hourly.by_hour?.length > 0 && (
              <div className="bg-white rounded-card shadow-card p-4 mb-6">
                <h3 className="text-sm font-semibold text-slate-700 mb-3">Activité par tranche horaire</h3>
            ...
            {hourly.heatmap?.length > 0 && (
              <div className="bg-white rounded-card shadow-card p-4 mb-6">
                <h3 className="text-sm font-semibold text-slate-700 mb-3">Activité jour × heure (heatmap CA)</h3>
