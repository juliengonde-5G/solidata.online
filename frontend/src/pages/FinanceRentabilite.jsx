        ...
        {loading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <KPICard title="Cout / tonne collecte" value={fmt(totaux.cout_tonne_collecte)} unit="EUR/t" icon={IconTruck} accent="primary" />
              <KPICard title="Cout / tonne tri" value={fmt(totaux.cout_tonne_tri)} unit="EUR/t" icon={IconFactory} accent="amber" />
              <KPICard title="CA total exutoires" value={fmtK(totaux.ca_total)} unit="EUR" icon={IconEuro} accent="emerald" />
              <KPICard title="Marge totale" value={fmtK(totaux.marge_totale)} unit="EUR" icon={IconTarget} accent={totaux.marge_totale >= 0 ? 'emerald' : 'red'} />
            </div>
            ...
            <div className="card-modern p-6">
              <h3 className="text-base font-semibold text-slate-800 mb-1 flex items-center gap-2">
                <IconQuality className="w-5 h-5 text-slate-400" />
...
function IconTarget({ className }) {
  return <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0-4a8 8 0 100 16 8 8 0 000-16zm0 8h.01" /></svg>;
}
