...
const gestionnaireToken = jwt.sign({ id: 2, username: 'manager', role: 'MANAGER', first_name: 'M', last_name: 'G', mfa: true, mfa_at: Math.floor(Date.now() / 1000) }, JWT_SECRET, { expiresIn: '1h' });
const collabToken = jwt.sign({ id: 3, username: 'collab', role: 'COLLABORATEUR', first_name: 'C', last_name: 'L', mfa: true, mfa_at: Math.floor(Date.now() / 1000) }, JWT_SECRET, { expiresIn: '1h' });
