...
function resetDb() {
  db = {
    users: [{ id: 1, username: 'admin', password_hash: HASH, role: 'ADMIN', email: 'a@x.fr', first_name: 'A', last_name: 'D', phone: null, team_id: null, is_active: true, token_version: 0, must_change_password: false, failed_login_count: 0, last_failed_login_at: null, locked_until: null, mfa_enabled: false, mfa_secret: null, mfa_enrolled_at: null, mfa_backup_codes: null, mfa_failed_count: 0, mfa_last_failed_at: null }, { id: 2, username: 'collab', password_hash: HASH, role: 'COLLABORATEUR', email: null, first_name: 'C', last_name: 'L', phone: null, team_id: null, is_active: true, token_version: 0, must_change_password: false, failed_login_count: 0, last_failed_login_at: null, locked_until: null, mfa_enabled: false, mfa_secret: null, mfa_enrolled_at: null, mfa_backup_codes: null, mfa_failed_count: 0, mfa_last_failed_at: null }, { id: 3, username: 'manager', password_hash: HASH, role: 'MANAGER', email: null, first_name: 'M', last_name: 'G', phone: null, team_id: null, is_active: true, token_version: 0, must_change_password: false, failed_login_count: 0, last_failed_login_at: null, locked_until: null, mfa_enabled: false, mfa_secret: null, mfa_enrolled_at: null, mfa_backup_codes: null, mfa_failed_count: 0, mfa_last_failed_at: null }, // Praticien PCM — RETIRÉ du périmètre MFA par arbitrage client (2.43.0).
      { id: 4, username: 'praticien', password_hash: HASH, role: 'PCM', email: null, first_name: 'P', last_name: 'C', phone: null, team_id: null, is_active: true, token_version: 0, must_change_password: false, failed_login_count: 0, last_failed_login_at: null, locked_until: null, mfa_enabled: false, mfa_secret: null, mfa_enrolled_at: null, mfa_backup_codes: null, mfa_failed_count: 0, mfa_last_failed_at: null }],
    refreshTokens: [],
    settings: {},
    customRoles: [],
  };
