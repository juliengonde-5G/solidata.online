...
# pour que nginx puisse démarrer (certbot les remplacera ensuite via init-ssl.sh)
...
if [ ! -f "$CERT_DIR/fullchain.pem" ]; then
  ...
  echo "[NGINX] Certificats temporaires créés. Lancez ./init-ssl.sh pour les vrais certificats."
fi
